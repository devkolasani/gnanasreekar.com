		...
		<div className={styles.About} id="About">
			<div className={styles.Container}>
				...
				<div className={styles.DescriptionMobile}>
					<p>
						Hello, I'm Gnana Sreekar. How's it going? I'm an Android
						developer based in India and a hardware geek.
					</p>
				</div>
				<div className={styles.Download}>
					<a
						href="https://drive.google.com/file/d/1aaVYPMN5CdxaUyjCWf1iYI2swWGgcKxR/view"
